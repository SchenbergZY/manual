...
> TeachBooks Development Team (2024), _TeachBooks Manual_. https://doi.org/10.5281/zenodo.15100848. Retreived [Month, Year]. CC BY 4.0.
...
> `<Title of Chapter or Page>`. In TeachBooks Development Team (2024), _TeachBooks Manual_. https://doi.org/10.5281/zenodo.15100848. CC BY 4.0. (chapter `./book/intro/`, retrieved [`<date>`]).
